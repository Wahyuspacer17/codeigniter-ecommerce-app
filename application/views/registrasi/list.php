	...
	<div class="col-md-12">
		...
		<table class="table">
			<thead>
				<tr>
					<th width="25%">Nama</th>
					<th><input type="text" name="nama_pelanggan" class="form-control" placeholder="Nama lengkap" value="<?php echo set_value('nama_pelanggan') ?>" required title="Input Hanya Boleh Huruf dan Spasi" pattern="[A-Za-z\s]+"></th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					<td>Telepon</td>
					<td><input type="text" name="telepon" class="form-control" placeholder="Telepon" value="<?php echo set_value('telepon') ?>" required title="Nomor Tidak Valid" pattern="[0-9]{11,14}"></td>
				</tr>
				<tr>
					<td>Alamat</td>
