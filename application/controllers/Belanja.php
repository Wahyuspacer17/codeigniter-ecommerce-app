...
class Belanja extends CI_Controller {
	...
	public function add()
	{
		...
		if ($produk->stok < $qty ) {
			$this->session->set_flashdata('warning', 'mohon maaf stok tidak mencukupi');
	...
	public function checkout()
	{
		...
		// dan juga sekaligus login. Mengecek dengans session email
	...
	public function hapus($rowid='')
	{
		if($rowid) {
			...
			$this->session->set_flashdata('sukses', 'Data keranjang belanja telah diihapus');
			redirect(base_url('belanja'),'refresh');
		}else{
			// Hapus all
			$this->cart->destroy();
