...
<div class="col-sm-10">
  <input type="text" class="form-control" name="judul_galeri" placeholder="Judul Galeri" value="<?php echo set_value('judul_galeri')  ?>">
</div>
</div>
...
<div class="col-sm-10">
  <textarea name="isi" class="form-control textarea" placeholder="Isi"><?php echo set_value('isi') ?></textarea>
</div>
</div>
<div class="form-group row">
